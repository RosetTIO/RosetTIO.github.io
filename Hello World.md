...
## Table of Contents
 ...
 - [Minkolang, 20 bytes](#minkolang-20-bytes)
 ...
 - [Standard ML (MLton) (WARNING: wut it doesn’t work)](#standard-ml-mlton-warning-wut-it-doesnt-work)
...
## Assembly (gcc, x64, Linux), 114 bytes
```
.data
...
## Assembly (nasm, x64, Linux), 86 bytes
```
mov edx,13
mov ecx,s
mov ebx,1
...
## Half-Broken Car in Heavy Traffic, 3273 bytes
```
@outtext
...
## JavaScript (SpiderMonkey), 28 bytes
```
console.log('Hello, World!')
```
...
## Shakespeare Programming Language, 1186 bytes
```
a.
Ajax,a.
Puck,a.
...
## Standard ML (MLton) (WARNING: wut it doesn't work)
```
print "Hello, World!";
```
[Try it online!]()
...
## Taxi, 197 bytes
```
"Hello, World!"is waiting at Writer's Depot.Go to Writer's Depot:w 1 l, 2 r, 1 l, 2 l.Pickup a passenger going to Post Office.Go to Post Office:n 1 r, 2 r, 1 left.Go to Taxi Garage:n 1 r, 1 l, 1 r.
```
[Try it online!](https://tio.run/##XY6xCsJAEER/ZUxjEwJaphZiZwoh9RL3jsUjG/ZO4t@fpxgVu2GYeTOJ7pJzdeQQtMagFi6bSiIWkiSTByUMJoltG3HgWVPTKZL@me2CHUKNPaxeVWh6Ga@3GYSZYuTJs8HrE1r6vcaEk3My8pv447RTgdgXx26dPZe76MjIf0KvuaKanB8)
## Tcl, 19 bytes
```
puts Hello,\ World!
```
...
## Visual Basic .NET (Mono), 71 bytes
```
Module Hello
Sub Main
