...
## Table of Contents
 ...
 - [C# (.NET Core), 77 bytes](#c-net-core-77-bytes)
 - [C# (Mono), 77 bytes](#c-mono-77-bytes)
 ...
 - [Cubically, 123 bytes](#cubically-123-bytes)
 ...
 - [Erlang (escript), 38 bytes](#erlang-escript-38-bytes)
 - [ETA, 73 bytes](#eta-73-bytes)
 - [evil, 70 bytes](#evil-70-bytes)
 - [Explode, 92 bytes](#explode-92-bytes)
 - [ExtraC, 55 bytes](#extrac-55-bytes)
 ...
 - [LLVM IR, 155 bytes](#llvm-ir-155-bytes)
 - [Logicode, 121 bytes](#logicode-121-bytes)
 ...
 - [Numberwang, 77 bytes](#numberwang-77-bytes)
 ...
 - [PingPong, 32 bytes](#pingpong-32-bytes)
 ...
 - [Snails, 45 bytes](#snails-45-bytes)
 ...
 - [Surface (WARNING: INCORRECT)](#surface-warning-incorrect)
 ...
 - [Thutu, 24 bytes](#thutu-24-bytes)
 - [tinylisp, 18 bytes](#tinylisp-18-bytes)
 ...
 - [uBASIC, 22 bytes](#ubasic-22-bytes)
 ...
 - [Vala, 42 bytes](#vala-42-bytes)
 - [Visual Basic .NET (Mono), 71 bytes](#visual-basic-net-mono-71-bytes)
 - [Vitsy, 16 bytes](#vitsy-16-bytes)
 - [Whirl, 1350 bytes](#whirl-1350-bytes)
...
## [A Pear Tree](https://esolangs.org/wiki/A_Pear_Tree), 29 bytes
```
#r3TQJ
print("Hello, World!")
```
[Try it online!](https://tio.run/##S9QtSE0s0i0pSk39/1@5yDgk0IuroCgzr0RDySM1JydfRyE8vygnRVFJ8/9/AA)
...
!dlroW ,olleH
```
[Try it online!](https://tio.run/##SyxNSi1Kz8xL/f/fNtFRN9HQNt/RNilTO8lQ1zFJNynJKslR28nQNtPJPT8nTSGpUiGwNDOvJL8gM5FLMSWnKD9cQSc/JyfV4/9/AA)
...
```
0000000:26238100c8e5ececefaca0d7eff2ece4
0000010:21
```
[Try it online!](https://tio.run/##S0pNzPv/3wACrIzMjIwtDA0Mki1STVOTgTAtMTnRIMU8NS3NCMgz4QIrMwQqNPz/HwA)
...
## [Befunge](https://github.com/catseye/Befunge-93), 21 bytes
```
"!dlroW ,olleH">:#,_@
```
...
(((((((((((()()()()){}){}){}()))){}{}())[][][][])[][])[[]]())[[][][][][]]())([([]([])[][]{})]()()()([[]](([()()()]([([][][])](((({}()){}))){}{})))))
```
[Try it online!](https://tio.run/##SypKzMzTTctJzP7/XwMJaEKgZnUtBAGZIA6YER0LgZoQIjo2FiQIE4VwNaI1omM1oGqAJsRCTQSrBkqCebFgVWBTYkGWgk0HKobYBLJR8////7qOAA)
## [Brain-Flak (BrainHack)](https://github.com/Flakheads/BrainHack), 148 bytes
```
(((((((((((()()()()){}){}){}()))){}{}())[][][][])[][])[[]]())[[][][][][]]())([([]([])[][]{})]()()()([[]](([()()()]([([][][])](((({}()){}))){}{})))))
```
[Try it online!](https://tio.run/##SypKzMzLSEzO/v9fAwloQqBmdS0EAZkgDpgRHQuBmhAiOjYWJAgThXA1ojWiYzWgaoAmxEJNBKsGSoJ5sWBVYFNiQZaCTQcqhtgEslHz////uo4A)
...
```
[Try it online!](https://tio.run/##S9ZNzknMS///PzcxM09Ds7qgtKRYQ8kjNScnX0chPL8oJ0VRSdO69v9/AA)
...
main(){puts("Hello, World!");}
```
[Try it online!](https://tio.run/##S9YtSU7@/z83MTNPQ7O6oLSkWEPJIzUnJ19HITy/KCdFUUnTuvb/fwA)
## [C# (.NET Core)](https://www.microsoft.com/net/core/platform), 77 bytes
```
using System;class A{static void Main(){Console.WriteLine("Hello, World!");}}
```
[Try it online!](https://tio.run/##BcExCoAwDADAr8ROFtQPOImLg04OnUsNEogNNFWQ4tvrXdA@SMJab6V4wv5qxmsM7FVhKpp9pgCP0AGbp9jaMktUYRxcoowrRWzNgszSgZPER2Ps@H21/g)
## [C# (Mono)](http://www.mono-project.com/), 77 bytes
```
using System;class A{static void Main(){Console.WriteLine("Hello, World!");}}
```
[Try it online!](https://tio.run/##BcExCoAwDADAr0SnCuoHnMTFQSeHzqUGCcQETBVE@vZ6F607VbSU20gO2F5LeA6RgxmMn6WQKMKjtMMaSFzzTSqmjL2/KOFCgq6ekVlb8HrxXtXNkHMpPw)
...
## [COBOL (GNU)](https://sourceforge.net/projects/open-cobol/), 55 bytes
```
PROGRAM-ID.H.PROCEDURE
DIVISION.DISPLAY "Hello, World!".
```
[Try it online!](https://tio.run/##S85Pys/RTc8r/f8/IMjfPcjRV9fTRc9DD8hxdnUJDXLlcvEM8wz29PfTc/EMDvBxjFTySM3JyddRCM8vyklRVNL7//9fclpOYnrxf920otRUAA)
## [CoffeeScript](http://coffeescript.org/), 28 bytes
```
...
## [Common Lisp](http://www.clisp.org/), 25 bytes
```
(format t"Hello, World!")
```
[Try it online!](https://tio.run/##S87JLC74/18jLb8oN7FEoUTJIzUnJ19HITy/KCdFUUnz/38A)
...
## [cQuents](https://github.com/stestoltz/cQuents), 15 bytes
```
Hello, World!?0
```
...
## [Cubically](https://github.com/aaronryank/cubically), 123 bytes
```
...
```
[Try it online!](https://tio.run/##NYs7DoAgEEQPtCHuB7agIhZUVCQcQKlMaC08PaJiM@8lM1PP/ahba1fv4CQoUOTEgEETRy6SJVIi4KCaJEqmQqs8tbeFMgEONfgkOPyIOIXNr8aBxTkNuuB78wNTe78B)
...
## [Decimal](https://github.com/aaronryank/Decimal), 46 bytes
```
13072101108108111044032087111114108100033D 301
```
[Try it online!](https://tio.run/##S0lNzsxNzPn/39DYwNzI0MDQ0MAChIC0iYmBsZGBhbkhCJiAxQ0MjI1dFIwNDP///68MAA)
...
## [Erlang (escript)](http://erlang.org/doc/man/escript.html), 38 bytes
```

main([])->io:fwrite("Hello, World!").
```
[Try it online!](https://tio.run/##Sy3KScxL100tTi7KLCj5/58rNzEzTyM6VlPXLjPfKq28KLMkVUPJIzUnJ19HITy/KCdFUUlT7/9/AA)
...
```
[Try it online!](https://tio.run/##Sy1J/P/fz9PP1c/RwxFIhPgDCUcwK9jVL8QPyPX0dPULhomAFbh6AFUD6RB/R1d/ZPD/PwA)
...
## [Explode](https://github.com/stestoltz/Explode), 92 bytes
```
@1_0+E
@1_0+17
@1_0+1e
...
@1_0+1
```
[Try it online!](https://tio.run/##S60oyMlPSf3/38Ew3kDblQtMGZpD6VQ0OgNCJ3NB6BBUYcNsNOVmUPr/fwA)
## [ExtraC](https://github.com/ConorOBrien-Foxx/extrac), 55 bytes
```
printf(quote(Hello)CHAR CHAR quote(World)CHAR,44,32,33)
```
[Try it online!](https://tio.run/##S60oKUpM/v@/oCgzryRNo7A0vyRVwyM1Jydf09nDMUgBTEBEw/OLclLAojomJjrGRjrGxpr//wMA)
...
## [FOCAL-69](http://www.cozx.com/dpitts/), 25 bytes
```
10.10 t "Hello, World!"
g
```
[Try it online!](https://tio.run/##S8tPTsz5/9/QQM/QQKFEQckjNScnX0chPL8oJ0VRiSv9/38A)
...
## [Gambit Scheme (gsi)](http://gambitscheme.org), 24 bytes
```
(display"Hello, World!")
```
[Try it online!](https://tio.run/##K07OSM1N1U1PzE3KLPn/XyMls7ggJ7FSySM1JydfRyE8vygnRVFJ8/9/AA)
...
```
[Try it online!](https://tio.run/##hVDLDoAwCPvWsoMeTPTq16Mgix2TGJasQMtr2c5j3VUBaRAzgf/uBxbG3cwvYqw1PNVKeuaM3JHjtNyf8@g44g3TXN@z8O5Ug@7x7pp6RC7v/DtrQ1FrvEV5l2JulzzO/UxjMVG9AA)
## [Glypho (shorthand)](https://web.archive.org/web/20060621185740/http://www4.ncsu.edu/~bcthomp2/glypho.txt), 120 bytes
```
1d+d1+d*+ddd++ddd++1+d11+d*d++d11+1+d++d1-dd+++d1<d>+-d++11+d*d*d+<d>d+d+d<d>+d+1+d1-dd+++d1-<d>+d*1+11+1+d+d*d+<d-+>[o]
```
[Try it online!](https://tio.run/##NYwxDoAwDAP/UytDdtSPIAYkS3RAtAIWXh@SFpbEdi7e9qeVKlep513Wg2ZKUMEEkhjDrUYU3oXLEBIn3xMzJKiOOOSBd4BxYH/@UelRUnwtgxbkuS5mLw)
## [gnuplot](http://www.gnuplot.info/), 33 bytes
```
set print'-'
print'Hello, World!'
```
...
>v<
 ...
 v ^
```
[Try it online!](https://tio.run/##7Zc7bsMwDEB3ncJAD9ALCERPwqFFgWxZXKG3d6mf9TFJsQjQoYgXO/Ez9UJTonJ7/7jtx/F2/9r3z@/dbfEIm3xAvYkOIugVtgQCQO/SB9RihxI2n7TIA5nhJQl0fiWRsCQx/kgvjz@PLo8/xCQDefxwxnkpNCoOja6xNQ@Oll04WnaRTHgXnpZceFpykU04F4nmXcR8X1zi7Kh0Kft58CFJHT5rzyoaO4tUNiqg4xKAF5ZP3Wihs6OFzo4WK7a3WLG9hcXhLPIl2yzWbLOwOZT7BrZamPJbLKwOqbZMbLZYsgAtv@QhsGTZHWXGSXFTXaMfvgip0lkWWseqLJ79C7tmF9sTTrO@sTjHfbL/ik2LNQd7Br6EhaEgFZJrREJM/EuSzjY2TSZvjJvbT8fS015gr770NHrRd2RRyaztLdRXaGHPtmVgt0fY8AvW29htXj4XLG72uOLenlZaP7Hi7j5vrPPmiboHtToXS4laRPwP4ejCJSgBd6C7IXPxAo/jBw)
## [Haskell](https://www.haskell.org/), 26 bytes
```
main=putStr"Hello, World!"
```
[Try it online!](https://tio.run/##y0gszk7Nyfn/PzcxM8@2oLQkuKRIyQMokq@jEJ5flJOiqPT/PwA)
...
"Hello, World!"
```
[Try it online!](https://tio.run/##y/z/X8kjNScnX0chPL8oJ0VR6f9/AA)
...
## [INTERCAL](http://www.catb.org/~esr/intercal/), 285 bytes
```
...
```
[Try it online!](https://tio.run/##ZY/BCsIwEER/ZaHXCt00WVvwUmkQQWixxrtID4J4EP8/dnLIir3lTXjD7OP1md/32zPGfih5tynYEl5T2BdAUzeZDb4r5RrMhsaT7yafYwvNSWa3sGirwGrtv7VdYqvdDUq0owXalcQVykQ1Tpt/TkibZeWl6WI0wGgHprPvehrCpWTQ4Xj1FMYYvw)
...
quit
```
[Try it online!](https://tio.run/##y8qv/P@/uCQlv7REySM1JydfRyE8vygnRVEpraC0pLikKDMvXaEgv0CPq7A0s@T/fwA)
...
## [LLVM IR](http://llvm.org/docs/LangRef.html), 155 bytes
```
@s=constant[14 x i8]c"Hello, World!\00"declare i32@puts(i8*)define i32@main(){call i32@puts(i8*getelementptr([14 x i8],[14 x i8]*@s,i32 0,i32 0))ret i32 0}
```
[Try it online!](https://tio.run/##y8kpy/3/36HYNjk/r7gkMa8k2tBEoUIh0yI2WckjNScnX0chPL8oJ0UxxsBAKSU1OSexKFUh09jIoaC0pFgj00JLMyU1LTMPIpabmJmnoVmdnJiTg6ImPbUkNSc1NzWvpKCkSANugw6cpeVQrAPUoGAAITU1i1JLFMDM2v//AQ)
## [Logicode](https://github.com/LogicodeLang/Logicode), 121 bytes
```
var a=11011
var l=@(a+00)
var o=a+11
...
```
[Try it online!](https://tio.run/##NYpBCoBACEX3nWKWhRv/AQbmKlIRwYAQ1fVNR0LB932/63Guuu1mr1xFKsDAFNxrm4WYl5G0CrnQ5y4NzL5MDYNA3aepZ45PXE4fFkiX5Wgm/T2YfQ)
...
a:
	@:
```
[Try it online!](https://tio.run/##y03MTv3/X0UjMy8tX8EjNScnX0chPL8oJ0VRkyvRiovTwer/fwA)
...
## [Mathics](http://mathics.github.io/), 22 bytes
```
Print["Hello, World!"]
```
[Try it online!](https://tio.run/##y00sychMLv7/P6AoM68kWskjNScnX0chPL8oJ0VRKfb/fwA)
...
## [Minimal-2D](https://esolangs.org/wiki/Minimal-2D), 175 bytes
```
>++  R<+++D R >++++++>+++++++++>++++++++++D
D++>R/ </ +/U/-<<<<<<+++++++++++>+++>++++>L
+   UU/->+LD    .++++++++++>.--------.----L
R+++.>++.>--..+++.>.>-.>--.--------.+++.--U
```
[Try it online!](https://tio.run/##VYy9CsAwCIT3PIW7qNA5ZHLMFMgDFLoEmr7/lhoJ/TkQ745Pe7ta30/ajjESIkCJiKhQwNLUWj@HGtRyEYgCKFUoul7AYT9IOdhXqAYlzGoW@IMxLbnJoVjJaY5V7MGsp4ecLVEd4wY)
...
## [Numberwang](https://esolangs.org/wiki/Numberwang_(brainfuck_derivative)), 77 bytes
```
69696969696969693696969623673363316969696968359533059595636969663633563583193
```
[Try it online!](https://tio.run/##yyvNTUotKk/MS///38wSFRpDGUbGZubGxmbGxoZwOQtjU0tTY2MDIGlpagZRaAZSAuSYWhgbWhr//w8A)
...
main(){puts("Hello, World!");}
```
[Try it online!](https://tio.run/##y0/KSk0uySxL1U3WTc5JzEv//z83MTNPQ7O6oLSkWEPJIzUnJ19HITy/KCdFUUnTuvb/fwA)
...
print"Hello, World!"
```
[Try it online!](https://tio.run/##K0gtyjH9/7@gKDOvRMkjNScnX0chPL8oJ0VR6f9/AA)
...
@/=\#Hello  /
 \./
```
[Try it online!](https://tio.run/##K8jMSy/Iz0v//99ARTElpyg/XEVBRSeGy0HfNkbZIzUnJ19BQZ9LIUZP//9/AA)
...
## [Self-modifying Brainfuck](https://soulsphere.org/hacks/smbf/), 29 bytes
```
<[.<----------]
+nv|ya*6yvvoH
```
[Try it online!](https://tio.run/##K85NSvv/3yZaz0YXDmK5tPPKaioTtcwqy8ryPf7/BwA)
...
## [SISAL](https://github.com/TryItOnline/sisalc), 66 bytes
```
define main function main(returns array[character])"Hello, World!"
```
[Try it online!](https://tio.run/##HccxCoAwDAXQq8ROCh7EGziIQ2gjBmIKv@3g6SP4tte0sUUUudSFHlana3juWv3fDOkD3ogBfo98Mzh3wbmkTczqSnuFlSlFfA)
## [Snails](https://github.com/feresum/PMA), 45 bytes
```
\p|\P)z(\a|\A)z{\n|\N)z{\a|\A}z(\m|\M)z(\a|\A
```
[Try it online!](https://tio.run/##K85LzMwp/v8/pqAmJkCzSiMmsSbGUbOqOiavJsYPRIP4tUDx3JoYX5j8//@uuZEBGX6llVyOiYneYcVZPlz5eTnuZZnO5VwuKf7pbkVBeVyewakeUbmFyVxVvqHZTu5egQA)
...
## [Surface](https://github.com/TryItOnline/surface) (WARNING: INCORRECT)
```
++++++++(-v        .     o]v    
   +      e++++v   !     ^ v    
   +           e+++++++++^ x    
...
.--o+              .+v .--------
   ...
   -+              .+
```
[Try it online!](https://tio.run/##tdDBCsIwDAbg@56iuw1C/mfwRRYQideAYvHta1rrNuLUkz@00PDRpL3eLufjSUuhnolz6kHbbW6FwRc961pdLY7tKCmCVbVIuu@BGvaVeVJ8A14T@wjyrMvEu4CT0C9gC/B5kQNQRn8KMDBkpDewxluYRQAlHF4twBwB/D@xuSFxALQ9/weASnkA)
...
## [Thutu](https://esolangs.org/wiki/Thutu), 24 bytes
```
/^=1$/Hello, World!=x=9/
```
[Try it online!](https://tio.run/##K8koLSn9/18/ztZQRd8jNScnX0chPL8oJ0XRtsLWUv//fwA)
## [tinylisp](https://github.com/dloscutoff/Esolangs/tree/master/tinylisp), 18 bytes
```
(q(Hello, World!))
```
[Try it online!](https://tio.run/##K8nMq8zJLC74/1@jUMMjNScnX0chPL8oJ0VRU/P/fwA)
...
## [uBASIC](https://github.com/EtchedPixels/ubasic), 22 bytes
```
0PRINT"Hello, World!"

```
[Try it online!](https://tio.run/##K01KLM5M/v/fICDI0y9EySM1JydfRyE8vygnRVGJ6/9/AA)
...
```
[Try it online!](https://tio.run/##K0vMSfz/vyw/M0UhNzEzT0OzurgkJb@0RK@gtKRYQ8kjNScnX0chPL8oJ0VRSdO69v9/AA)
## [Visual Basic .NET (Mono)](http://www.mono-project.com/docs/about-mono/languages/visualbasic/), 71 bytes
```
Module Hello
Sub Main
...
End Module
```
[Try it online!](https://tio.run/##K8ssLk3M0U1KLM5M1s1LLdHNzc/L///fNz@lNCdVwSM1JyefK7g0ScE3MTOPyzk/rzg/J1UvvCizJFVDCSyroxCeX5SToqikyeWal6IAVAumIQb8/w8A)
## [Vitsy](https://github.com/VTCAKAVSMoACE/Vitsy), 16 bytes
```
"!dlroW ,olleH"Z
```
[Try it online!](https://tio.run/##K8ssKa78/19JMSWnKD9cQSc/JyfVQynq/38A)
## [Whirl](https://bigzaphod.github.io/Whirl/), 1350 bytes
```
...
```
[Try it online!](https://tio.run/##)
...
```
[Try it online!](https://tio.run/##K89MKcn4/989KrM83L88MMg/3DM7M8fJMTA8N9vf2SU3M829vPz/fwA)
